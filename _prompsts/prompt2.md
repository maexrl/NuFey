...
Agora vamos criar a autenticação do sistema. O sistema deve permitir que um nutricionista crie uma conta e faça login. Use o Neon Auth que já está configurado no projeto "NuFey".
...
- Cores predominantes vermelho e amarelo, remetendo à emoções intensas. 
- Logo com o texto "NuFey" no topo de ambas as telas.